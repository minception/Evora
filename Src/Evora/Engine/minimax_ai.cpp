...
double ai::minimax_ai::player_evaluate(std::shared_ptr<control::game_controller>& controller, int player_index) {
	model::wall wall = controller->get_model()->get_board(player_index).get_wall();
	auto pl_it = controller->get_model()->get_board(player_index).pattern_lines_begin();
...
double ai::minimax_ai::enemy_evaluate(std::shared_ptr<control::game_controller>& controller, int player_index) {
	model::wall wall = controller->get_model()->get_board(player_index).get_wall();
	return 0;
}
