...
{
	return "[options:time(int)|100, depth(int)|iterative deepening, abpruning(true or false)|true, moveorering(true or false)|true, pastround(true or false)|true]";
}
...
{
	return "[options:iterations(int)|500, constant(float)|0.2, heavy_playouts(true or false)|true]";
}
