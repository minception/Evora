...
{
	return "[options:time(int)|100, depth(int)|-, abpruning(true or false)|true, moveorering(true or false)|true, pastround(true or false)|true]";
}
...
{
	return "[options:time(int)|-, iterations(int)|500, constant(float)|0.2, heavy_playouts(true or false)|true]";
}
